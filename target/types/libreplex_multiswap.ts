export type LibreplexMultiswap = {
  "version": "0.0.0",
  "name": "libreplex_multiswap",
  "instructions": [
    {
      "name": "createSwap",
      "accounts": [
...
export const IDL: LibreplexMultiswap = {
  "version": "0.0.0",
  "name": "libreplex_multiswap",
  "instructions": [
    {
